...
const Hero = () => {
  return (
    <section className="relative min-h-[100vh] pt-24 md:pt-20 pb-10 text-white flex flex-col items-center justify-center text-center px-4 overflow-hidden">
      <Image
      ...
      >
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-8 text-sm md:text-base">
          <div>
            <span className="text-yellow-400 flex justify-center font-bold text-2xl">100+</span> Nigerian
            Businesses Served
          </div>
          <div>
            <span className="text-yellow-400 flex justify-center font-bold text-2xl">35%</span> Average Revenue Growth
          </div>
          <div>
            <span className="text-yellow-400 flex justify-center font-bold text-2xl">3</span> Integrated Solutions
          </div>
        </div>
      </motion.div>
    </section>
